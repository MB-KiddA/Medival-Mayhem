...
def p1_icon_movement(keys_pressed):
...
def p2_icon_movement(keys_pressed):
...
def char_select(keys_pressed):
    pick = 0
    
    while pick == 0:
        p1_icon_movement(keys_pressed)

    while pick == 1:
        p2_icon_movement(keys_pressed)
